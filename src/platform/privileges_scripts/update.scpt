on run {daemon_file, agent_file, user, cur_pid, source_dir}
  ...
  set copy_files to "rm -rf /Applications/KassatkaDesk.app && ditto " & source_dir & " /Applications/KassatkaDesk.app && chown -R " & quoted form of user & ":staff /Applications/KassatkaDesk.app && xattr -r -d com.apple.quarantine /Applications/KassatkaDesk.app;"
