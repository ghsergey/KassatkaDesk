...
pub fn get_icon() -> String {
    ...
    {
        let encoded = crate::common::encode64(include_bytes!("../res/128x128.png"));
    ...
    #[cfg(any())] // Legacy embedded RustDesk icon; kept disabled to avoid rewriting the huge data URI.
    {
