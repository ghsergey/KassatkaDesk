...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\KassatkaDeskPrinterDriver\\KassatkaDeskPrinterDriver.inf";
    LPCWCH RD_PRINTER_PORT = L"KassatkaDesk Printer";
    LPCWCH RD_PRINTER_NAME = L"KassatkaDesk Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"KassatkaDesk v4 Printer Driver";
